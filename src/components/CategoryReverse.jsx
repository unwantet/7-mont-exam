...
export default function CategoryReverse({product}) {
    ...
    return (
        ...
        <div className='flex gap-[125px] items-center mb-40'>
            <div>
                ...
                <Link to={`/product/${product.id}`} className="bg-orang hover:bg-hoverOrange btn rounded-none max-w-40 border-0 text-white font-semibold text-xs">
                SEE PRODUCT
                </Link>
            </div>
